...
class Settings:
    ...
    MODEL_NAME: str = os.getenv("MODEL_NAME", "qwen-coder-1.5b")
    MODEL_FILE: str = os.getenv("MODEL_FILE", "qwen2.5-coder-1.5b-instruct-q4_k_m.gguf")
    MODEL_PATH: str = os.getenv(
        "MODEL_PATH",
        str(Path(__file__).resolve().parent.parent / "models" / os.getenv("MODEL_FILE", "qwen2.5-coder-1.5b-instruct-q4_k_m.gguf")),
    )
    MODEL_URL: str = os.getenv("MODEL_URL", "https://huggingface.co/Qwen/Qwen2.5-Coder-1.5B-Instruct-GGUF/resolve/main/qwen2.5-coder-1.5b-instruct-q4_k_m.gguf")
